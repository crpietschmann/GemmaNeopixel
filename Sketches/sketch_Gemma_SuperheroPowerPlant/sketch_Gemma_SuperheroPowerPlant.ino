    ...
    //originally from https://learn.adafruit.com/superhero-power-plant/overview
    ...
    void loop() {
      ...
      //colorWipe(strip.Color(0, alpha, 0)); // Green
      //colorWipe(strip.Color(alpha, 0, 0)); // Red
      //colorWipe(strip.Color(alpha, alpha, alpha)); // White
      //colorWipe(strip.Color(alpha, alpha / 4.7, 0)); // Orange
      //colorWipe(strip.Color(alpha, alpha / 1.5, 0)); // Yellow
